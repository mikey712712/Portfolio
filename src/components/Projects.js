	...
	return (
		...
		>
			...
			>
				...
				>
					...
					<Box p={[, , , "0 0 0 25px"]}>
						...
						<Text>
							...
							through FirebaseAuth. All other non-sensitive data was stored in Firebase's FireStore.
						</Text>
					</Box>
				</Flex>
				<Flex p={[, , "0 0 0 15px"]} m="0 0 65px 0" h={["fit-content", , , "300px"]} flexFlow={["column-reverse nowrap", , , "row nowrap"]}>
					<Image
						border={"2px solid rgba(255,255,255,0.7)"}
						borderRadius={"15px"}
				...
				<Flex p={[, , "0 0 0 15px"]} h={["fit-content", , , "300px"]} flexFlow={["column-reverse nowrap", , , "row nowrap"]}>
					<Image
						border={"2px solid rgba(255,255,255,0.7)"}
						borderRadius={"15px"}
